...
public class Comanda {
	...
	public void conta() {
		if (totalItensPedidos > 0) {
			...
			case 2:
				...
				// Receber o codigo do cliente no programa de fidelidade 
				// Fornecer a opção de cadastrar no sistema de fidelidade
				break;
	...
	public void descontos() {
		int opcao;
		System.out.println("Selecione o tipo de desconto: ");
		System.out.println("1- Padrao (5%)");
		System.out.println("2- Manual (x%)");
		System.out.println("3- Fidelide (10% a 20%)");
		System.out.println("4- Aniversario (20%)");
		opcao = entrada.nextInt();
		switch (opcao) {
		case 1:
			valorTotal = descontos.descontoPadrao(valorTotal);
			break;
		case 2:
			valorTotal = descontos.descontoManual(valorTotal);
			break;
		case 3:
			valorTotal = descontos.descontoFidelidade(valorTotal, cliente);
			break;
		default:
			break;
		}
